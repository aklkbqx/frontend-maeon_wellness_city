            ...
            <View style={tw`flex-row justify-between items-center`}>
              ...
              {programData ? (
                <TextTheme font="Prompt-Medium" size="xs" style={tw`text-gray-600`}>
                  {programData.schedules[0].activities[0].start_time.slice(0, 5)} -
                  {programData.schedules[0].activities[programData.schedules[0].activities.length - 1].end_time.slice(0, 5)}
                </TextTheme>
              ) : (
