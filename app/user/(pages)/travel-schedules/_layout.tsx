              ...
              <View style={tw`flex-row justify-center`}>
                <View style={tw`rounded-2xl overflow-hidden`}>
                  <View style={tw`p-2 bg-white`}>
                    <TextTheme size='lg'>คำเตือน!</TextTheme>
                  </View>
                  ...
                  <View style={tw`flex-row justify-between p-2 gap-2 bg-white`}>
                    <TouchableOpacity onPress={() => setDialogMessage(false)} style={tw`flex-1 bg-zinc-200 rounded-xl justify-center flex-row p-2`}>
                    ...
                    }} style={tw`flex-1 bg-blue-500 rounded-xl justify-center flex-row p-2`}>
