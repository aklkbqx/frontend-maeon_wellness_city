...
const Search = () => {
    ...
    return (
      ...
      >
        {item.image ? (
          ...
          <View style={tw`w-14 h-14 rounded-xl bg-gray-50 justify-center items-center`}>
  ...
  return (
    <View style={tw`flex-1 bg-gray-50`}>
      <View style={tw`mt-16 p-5 pt-0 flex-row items-center`}>
        <View style={tw`flex-row justify-start ml-2 flex-1`}>
        ...
        <View style={tw`flex-row justify-center flex-1`}>
          <TextTheme font='Prompt-SemiBold' size='lg'>ค้นหา</TextTheme>
        </View>
        <View style={tw`flex-row justify-center flex-1`} />
      </View>
