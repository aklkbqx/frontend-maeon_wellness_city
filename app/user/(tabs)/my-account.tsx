...
const MyAccount: React.FC = () => {
  ...
  return (
    <View style={tw`flex-1 bg-gray-100`}>
      ...
      >
        <View style={tw`flex-1 rounded-3xl overflow-hidden bg-white mb-5`}>
          <ProfileSection
            loading={isLoading}
          ...
          <View style={tw`mt-2`}>
            {userData ?
              <MenuSection title="บัญชีของฉัน" type="account" userData={userData} />
              : null
            }
        ...
        <View style={tw`flex-row justify-center mb-20`}>
          <TextTheme style={tw`text-slate-400`}>
            Version: {appVersion}
          </TextTheme>
        </View>
